...
class SSCUNET(nn.Module):
    def __init__(self, in_channels, out_channels, channels=16):
        ...
        self.downsample_2 = DownSample(channels * 2)
        self.downsample_3 = DownSample(channels * 4)
        self.downsample_4 = DownSample(channels * 8)
        ...
        self.upsample_4 = UpSample(channels * 2, channels)
